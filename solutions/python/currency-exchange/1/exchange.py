...
def exchangeable_value(budget: float, exchange_rate: float, spread:int, denomination:int) -> int:
    ...
    # Converts spread parameter integer to it's percentage representation
    spread_percentage: float = spread / 100
    print("spread_percentage:", spread_percentage)

    # Sums spread's percentage to exchange_rate parameter
    ...
    # Calculates and returns number of bills
    return get_number_of_bills(amount, denomination)
